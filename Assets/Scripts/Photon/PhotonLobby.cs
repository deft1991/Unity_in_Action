...
public class PhotonLobby : MonoBehaviourPunCallbacks
{
    ...
    public TextMeshProUGUI txtNumPlayers;
    ...
    void CreateRoom()
    {
        ...
        RoomOptions
            ...
            {
                IsVisible = true, IsOpen = true, MaxPlayers = 20
            }; //all of our players in the same room, if we want multiple rooms, make MaxPlayers to a small number
